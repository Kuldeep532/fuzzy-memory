...
object NexusGatekeeper {
    ...
    private val featureAccessMap: Map<FeatureId, FeatureAccess> = mapOf(
        ...
        FeatureId.NETWORK_INFO         to FeatureAccess.PUBLIC,
        FeatureId.APP_INFO_CENTER      to FeatureAccess.PUBLIC,
        FeatureId.EMERGENCY_GUARDIAN   to FeatureAccess.PUBLIC,
        FeatureId.NEWS                 to FeatureAccess.PUBLIC,
        FeatureId.SCIENCE              to FeatureAccess.PUBLIC,
        FeatureId.NEXUS_GAMES          to FeatureAccess.PUBLIC,
        FeatureId.EXPENSE_TRACKER      to FeatureAccess.PUBLIC,
        FeatureId.NEXUS_DIALER         to FeatureAccess.PUBLIC,
        FeatureId.TEXT_ANALYZER        to FeatureAccess.PUBLIC,
        FeatureId.URL_SHORTENER        to FeatureAccess.PUBLIC,
        FeatureId.COLOR_PALETTE        to FeatureAccess.PUBLIC,
        FeatureId.TEXT_TO_PDF          to FeatureAccess.PUBLIC,
