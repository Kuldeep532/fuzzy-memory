...
object FeatureCatalog {
    ...
    val allFeatures: List<FeatureItem> = listOf(
        ...
        FeatureItem(
            ...
            description = "AI-powered video analysis using Gemini. Upload a video and get detailed description with download & save options.",
            icon        = Icons.Filled.VideoLibrary,
            route       = Screen.VideoDescription.route,
            category    = FeatureCategory.TOOLS,
            keywords    = listOf("video", "description", "ai", "gemini", "analysis", "upload", "download"),
            isNew       = true,
        ),
        FeatureItem(
            id          = FeatureId.VIDEO_GENERATION,
            name        = "Video Generation",
            description = "Generate AI videos from text prompts using Gemini. Download, save and share your creations.",
            icon        = Icons.Filled.Movie,
            route       = Screen.VideoGeneration.route,
            category    = FeatureCategory.MEDIA,
            keywords    = listOf("video", "generation", "ai", "gemini", "prompt", "create", "download"),
            isNew       = true,
        ),
        FeatureItem(
